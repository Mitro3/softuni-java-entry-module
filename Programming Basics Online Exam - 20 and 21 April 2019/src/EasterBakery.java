...
public class EasterBakery {
    public static void main(String[] args) {
        ...
        int eggsPacksCount = Integer.parseInt(scanner.nextLine());
        int yeastPacks = Integer.parseInt(scanner.nextLine());

        double sugarPrice = flourPrice * 0.75;
        double eggsPackPrice = flourPrice * 1.1;
        double yeastPackPrice = sugarPrice * 0.2;
        double priceTotal = flourPrice * flourKg + sugarPrice * sugarKg + eggsPackPrice * eggsPacksCount + yeastPackPrice * yeastPacks;
